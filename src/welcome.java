...
public class welcome extends JPanel implements ActionListener {
    ...
    public welcome(masterwindow parent, String uid) {
        pointer = parent;
        ...
        try{
            ...
            ResultSet rs=stmt.executeQuery("select fname, mname, lname from users where userid=\""+uid+"\"");
        ...
        b2 = new JButton("Calculate tax");
        b2.addActionListener(this);
        b2.setActionCommand("calculator");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (cmd.equals("update")){
            ...
            pointer.setTitle("Calculate Tax");
            pointer.show("calculator");
        }
    }
}
