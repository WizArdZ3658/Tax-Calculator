...
public class createac_admin extends JFrame implements ActionListener {
    private JLabel l[];
    private JLabel l2[];
    private JLabel l3;
    ...
    public createac_admin(){
        ...
        l[8] = new JLabel("Set password");
        pf1 = new JPasswordField();
        pf1.setBounds(300,450,300,35);

        l[9] = new JLabel("Confirm password");
        ...
        if ("createac".equals(cmd)){
            ...
            if (flag){
                try{
                    ...
                    ResultSet rs = stmt.executeQuery("select userid from admins where userid=\""+uid+"\"");
                    if (rs.next()) {
            ...
            if (flag){
                ...
                /*String code = "";
                code = JOptionPane.showInputDialog(null,"Enter the six digit verification code sent to your e-mail id");*/
            ...
            if (flag){
                try{
                    ...
                    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/testdb","root","admin");
                    Statement stmt = con.createStatement();
                    String query = "insert into admins values(\""+uid+"\",\""+fname+"\",\""+mname+"\",\""+lname+"\",\""+gender+"\",\""+add+"\",\""+pno+"\",\""+email+"\",\""+pwd+"\")";
    ...
    public static void main(String[] args) {
        createac_admin se = new createac_admin();
