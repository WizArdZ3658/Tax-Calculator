...
public class update_admin extends JPanel implements ActionListener {
    ...
    public update_admin(masterwindow_admin parent, String uid) {
        username = uid;
        pointer = parent;
        l = new JLabel[10];
        l2 = new JLabel[10];
        ...
        l[4] = new JLabel("Address");
        tf[3].setBounds(300, 250, 300, 35);

        l[5] = new JLabel("Phone no. (10 digit)");
        tf[4].setBounds(300, 300, 300, 35);

        l[6] = new JLabel("E-mail ID");
        tf[5].setBounds(300, 350, 300, 35);



        l[7] = new JLabel("User ID");
        tf[6].setBounds(300, 400, 300, 35);

        l[8] = new JLabel("Old password");
        pf1 = new JPasswordField();
        pf1.setBounds(300, 450, 300, 35);

        l[9] = new JLabel("New password");
        pf2 = new JPasswordField();
        pf2.setBounds(300, 500, 300, 35);
        ...
        try{
            ...
            ResultSet rs = stmt.executeQuery("select userid, fname, mname, lname, gender, address, phone, email from admins where userid=\""+username+"\";");

            if (rs.next()) {
                tf[6].setText(rs.getString(1));             //user id
                //System.out.println(rs.getString(1));
                tf[0].setText(rs.getString(2));             //first name
                tf[1].setText(rs.getString(3));             //middle name
                tf[2].setText(rs.getString(4));             //last name
                tf[3].setText(rs.getString(6));             //address
                tf[4].setText(rs.getString(7));             //phone
                tf[5].setText(rs.getString(8));             //e-mail
                old_email_id = rs.getString(8);
    ...
    public void actionPerformed(ActionEvent e3) {
        ...
        if ("update".equals(cmd)){
            ...
            if ((pwd1.equals("") || pwd1==null) && (pwd2.equals("") || pwd2==null)) {
                ...
                l2[8].setForeground (Color.red);
                l2[8].setVisible(true);
                ...
                try{
                    ...
                    if (rs2.next()){
                        ...
                        if (!BCrypt.checkpw(pwd1, pw)){
                            ...
                            l2[8].setForeground (Color.green);
                            l2[8].setVisible(true);
                        }
            ...
            if (add.equals("") || add==null){
                l2[4].setForeground (Color.red);
                l2[4].setVisible(true);
                l3.setText("* necessary field");
                l3.setVisible(true);
                flag = false;
            }
            else{
                l2[4].setForeground (Color.green);
                l2[4].setVisible(true);
            }
            ...
            if (!email.equals(old_email_id)){
                if (flag){
                    ...
                    if (result!=rand_int1){
                        ...
                        JOptionPane.showMessageDialog(null,"Your e-mail address has been successfully updates","Success",JOptionPane.INFORMATION_MESSAGE);
                    }
                }
            }
            ...
            if (flag){
                try{
                    ...
                    if (pwd_flag){
                        ...
                        stmt.executeUpdate("UPDATE admins SET fname =\""+fname +"\", mname =\""+mname +"\",lname =\""+lname +"\",gender =\""+gender+"\",address=\""+add+"\",phone=\""+ pno+"\",email= \""+email+"\",password=\""+pow+"\" WHERE userid = \"" + username + "\";");
                    }
                    else{
                        stmt.executeUpdate("UPDATE admins SET fname =\""+fname +"\", mname =\""+mname +"\",lname =\""+lname +"\",gender =\""+gender+"\",address=\""+add+"\",phone=\""+ pno+"\",email= \""+email+"\" WHERE userid = \"" + username + "\";");
                    }
